        ...
        document.querySelectorAll('#origen').forEach(c => {
                ...
                c.addEventListener('change', e => {
					...
					if (!routeTo && e.target.value) {
						...
						document.getElementById(routeFrom).classList.add("paradaDesde")
					...
					if (routeTo && e.target.value) {
						state = 2;
						routeFrom = e.target.value
						document.getElementById(routeFrom).classList.add("paradaHasta")
        ...
        document.querySelectorAll('#destino').forEach(c => {
                ...
                c.addEventListener('change', e => {
					...
					if (!routeFrom && e.target.value) {
						...
						document.getElementById(routeTo).classList.add("paradaHasta")
					} 
        ...
        document.querySelectorAll('circle, rect').forEach(c => {
                ...
                c.addEventListener('click', e => {
                        if (state === 0) {
                                ...
                                console.log("FROM: " + routeFrom)
								document.getElementById('origen').value = routeFrom;
                        } else if(state === 1) {
                                // Set to point
                                state = 2;
                                //e.target.setAttribute("r",selectedRadious)
								...
								document.getElementById('destino').value = routeTo;
...
// Remove route info
	...
	//document.getElementById("cornerleft").innerHTML = "";
	...
	p.innerHTML = "<b align='right'>Tiempo aproximado: " +  (minTime).toFixed(0) +  " min </b> "
